export const actiontTypes = {
    adminSuccess: 'ADMIN_LOGIN_SUCCESS',
    ...
    companyLoginFailed: 'COMPANY_LOGIN_ERROR',
    companySignupSuccess: 'COMPANY_SIGNUP_SUCCESS',
    companySignupFailed: 'COMPANY_SIGNUP_ERROR',
